...
export interface ITaskGridDatasetControl extends IDatasetControl {
    ...
    /** Returns the saved grid panel width in pixels for the active saved query, when available. */
    ...
    /** Updates the grid panel width in pixels on the active saved query. */
